...
iteration_buffer = 50
mice_numbers = [1, 5, 8]  # array of numbers 1-7
...
multitaper_data_file_path = training_data_path + 'Sxx_norm_210202_210223_Galcre_m{mouse_num}.h5'
state_file_path = training_data_path + 'states_210202_210223_Galcre_m{mouse_num}.h5'
lda_file_path = training_data_path + 'lda_210202_210223_Galcre_m{mouse_num}.joblib'
knn_file_path = training_data_path + 'knn_210202_210223_Galcre_m{mouse_num}.joblib'
norm_file_path = training_data_path + 'norm_210202_210223_Galcre_m{mouse_num}.npy'
