...
Sxx_combined, multitaper_combined,states_combined = combine_files(EphysDir,Folder,save=True)

# get rid of any states that are only wake
Sxx_combined = Sxx_combined[states_combined['states']!='Wake']
multitaper_combined = multitaper_combined[states_combined['states']!='Wake']
